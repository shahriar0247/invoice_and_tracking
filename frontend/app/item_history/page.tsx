...
export default function ItemHistorys({ create = true, item_history_id_view = '' }) {
    ...
    function fetch_item_history() {
        fetch('http://86.38.217.198:5003/get/item_history')
    ...
    function deleteItemHistory(item_historyId) {
        fetch(`http://86.38.217.198:5003/delete/item_history/${item_historyId}`, {
            method: 'DELETE',
        })
            .then((response) => {
                if (response.ok) {
    ...
    function change_item_history_status(id, status) {
        ...
        fetch(`http://86.38.217.198:5003/item_history/change_status`, {
            method: 'POST',
            headers: {
...
function Create_item_history({ create = true, item_history_id_view = '', edit = false, fetch_item_history, onCloseParent }) {
    ...
    async function get_item_history_details() {
        const response = await fetch('http://86.38.217.198:5003/get_item_history_details/' + item_history_id_view);
    ...
    function createItemHistory() {
        ...
        fetch('http://86.38.217.198:5003/create/item_history/' + item_history_id, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
