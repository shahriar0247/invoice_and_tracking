...
export default function Purchase_Orders({ create = true, purchase_order_id_view = '' }) {
    ...
    function fetch_purchase_orders() {
        fetch('http://86.38.217.198:5003/get/purchase_order')
    ...
    function deletePurchase_Order(purchase_orderId) {
        fetch(`http://86.38.217.198:5003/delete/purchase_order/${purchase_orderId}`, {
            method: 'DELETE',
        })
            .then((response) => {
                if (response.ok) {
    ...
    function change_purchase_order_status(id, status) {
        ...
        fetch(`http://86.38.217.198:5003/purchase_order/change_status`, {
            method: 'POST',
            headers: {
...
function Create_purchase_order({ create = true, purchase_order_id_view = '', edit = false, fetch_purchase_orders, onCloseParent }) {
    ...
    async function get_purchase_order_details() {
        const response = await fetch('http://86.38.217.198:5003/get_purchase_order_details/' + purchase_order_id_view);
    ...
    function createPurchase_Order() {
        ...
        fetch('http://86.38.217.198:5003/create/purchase_order/' + purchase_order_id, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
