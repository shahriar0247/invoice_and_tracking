...
export default function BillTo({ }) {
    ...
    function fetch_bill_to() {
        ...
        fetch(`http://86.38.217.198:5003/get/type/${item}`)
    ...
    function handle_delete_click(bill_to_id) {
        fetch(`http://86.38.217.198:5003/delete/type/${item}/${bill_to_id}`, {
            method: 'DELETE',
        })
    ...
    function get_bill_to_details(bill_to_id) {
        fetch(`http://86.38.217.198:5003/get/type/${item}/${bill_to_id}`)
            .then((response) => response.json())
            .then((data) => {
    ...
    function edit_bill_to_id_() {
        ...
        const apiUrl = create_mode ? `http://86.38.217.198:5003/create/type/${item}` : `http://86.38.217.198:5003/edit/type/${item}/${edit_bill_to_id}`;
