...
export default function App() {
    ...
    function toggleEditModal(itemId) {
        ...
        onOpen();
        fetch(`http://89.116.50.93:5003/get/item/${itemId}`)
    ...
    function createItem() {
        ...
        fetch('http://89.116.50.93:5003/create/item', {
            method: 'POST',
            headers: {
    ...
    function editItem() {
        ...
        fetch(`http://89.116.50.93:5003/edit/item/${editItemId}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    function handle_delete_click(item_id) {
        fetch(`http://89.116.50.93:5003/delete/item/${item_id}`, {
            method: 'DELETE',
        })
